...
<html>
    ...
    <body>
        ...
        <div class="card-body" style="width:100%; margin-top: 5%;">
            <label style="text-align:center; font-size:20px;">Editing Movie - 
                        <?php 
                        
                        $id = "";
                        if(isset($_GET["id"])){
                            $id = $_GET["id"];
                            $_SESSION['curEditID'] = $id;
                        }
                        
                        $currentMovie = "SELECT * FROM movies WHERE id = '$id'";
                        $result = mysqli_query($conn, $currentMovie);
                        $row = mysqli_fetch_assoc($result);
                        
                        echo $row['name'];
                        ?></label>
            <table class="table table-bordered table-striped" align="center">
                <form action="../admin/handle_edit.php?id=<?php echo $row['id'];?>"  method="post" enctype="multipart/form-data">
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="text" name="length" value="<?php echo $row['length'];?>"   required >
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="number" min="10" name="adultTicket" value="<?php echo $row['priceAdult'];?>"   required>
                            
                        </td>
                        <td>
                            <label>Ticket Price (Kid)</label>
                            <input type="number" min="10" name="kidTicket" value="<?php echo $row['priceKid'];?>"   required>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                            <div class="d-grid gap-2 col-6 mx-auto">
                                <button type="submit" name="submit" class="btn btn-primary" style="font-size:18px;">Update</button>
                            </div>
                        </td>
                    </tr>
