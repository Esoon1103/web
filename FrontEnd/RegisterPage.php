        ...
        <body style="background-color:whitesmoke;">
            ...
            <form action="LoginPage.php">
                <div class="container" style="margin-top:5%;">
                  ...
                  <input type="password" placeholder="Enter Password" name="psw" id="psw" onChange="checkPassword()" pattern="^(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{7,}$" title="Minimum of 7 characters. Should have at least one special character and one number and one UpperCase Letter." required>
                  ...
                  <input type="text" placeholder="Enter Mobile Number" name="mobile" id="mobile" pattern="\+?6?(?:01[0-46-9]\d{7,8}|0\d{8})" required>
                  <hr>
